...
<%--        <h2 class="session">${name}</h2>--%>
        ...
        <div id="form-entry">       <%--  login and signup forms  --%>
            <div class="sign-up"> <%-- signup div --%>
                <form id="form-signup" method="post">
                    ...
                    <br/>
                    <label>Enter Password : <input id="sign-password-1" type="password" name="sign-password-1" required></label>
                    <br/>
                    <label>Re-Enter Password : <input id="sign-password-2" type="password" name="sign-password-2" required></label>
                    <br/>
        ...
        <div class="show row justify-content-md-center"></div>
